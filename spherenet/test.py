...
#     test_metanet(0.8, points, values, sphere_file, cone_file, sdf_file)


def test_metanet(baseline_points, baseline_values, sphere_file, cone_file, sdf_file, output_dir="./output"):
...
if __name__ == "__main__":
    ...
    test_metanet(points, values, sphere_file, cone_file, sdf_file)
