...
def build_pointnet2_seg(scope, X, out_dims, is_training, bn_decay):
    #scope: variable for TensorFlow operations
    #X: input point cloud
    #out_dims: list of output dimensions for final fully connected layers
    #is_training: boolean, whether the model is training
    #bn_decay: batch normalization decay rate
    with tf.variable_scope(scope):
        l0_xyz = tf.slice(X, [0,0,0], [-1,-1,3])
        l0_points = tf.slice(X, [0,0,3], [-1,-1,0])

        # Set Abstraction layers
        #downsample the point cloud and extract features at multiple scales

        #layer 1: 512 points, 64 features, 64 features, 128 features
        ...
        #layer 2: 128 points, 128 features, 128 features, 256 features
        ...
        #layer 3: 1024 points, 256 features, 512 features, 1024 features
        ...
        #upsample point cloud and propgate features from the set abstraction layers
        #in other words, we are trying to recover the original point cloud and its features

        #layer 1: 128 points, 256 features, 256 features
        l2_points = pointnet_fp_module(l2_xyz, l3_xyz, l2_points, l3_points,
                [256,256], is_training, bn_decay, scope='fa_layer1')

        #layer 2: 512 points, 64 features, 128 features
        l1_points = pointnet_fp_module(l1_xyz, l2_xyz, l1_points, l2_points,
                [256,128], is_training, bn_decay, scope='fa_layer2')

        #layer 3: 2048 points, 3 features, 128 features
        ...
        #applies 1D concolution layers to popogated features for final output 
